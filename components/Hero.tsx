    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-900/30 border border-indigo-500/30 text-indigo-300 mb-8 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              href="#contact" 
              className="group bg-white text-slate-900 px-8 py-4 rounded-lg font-bold text-lg transition-all hover:bg-indigo-50 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center justify-center"
            >
              {t('hero.ctaPrimary')}
            ...
            <a 
              href="#services" 
              className="px-8 py-4 rounded-lg font-bold text-lg text-white border border-slate-700 hover:bg-slate-800 hover:border-slate-600 transition-all flex items-center justify-center"
            >
              {t('hero.ctaSecondary')}
            </a>
          </div>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-slate-800 pt-10">
            <div>
              ...
              <div className="text-sm text-slate-500">{t('hero.stats.retention')}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-sm text-slate-500">{t('hero.stats.roi')}</div>
            </div>
            <div>
